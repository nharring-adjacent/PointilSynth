...
// class StochasticModel; // Not strictly necessary if PointilismInterfaces.h is
// included correctly
...
private:
  ...
  // This is important because nlohmann::json doesn't automatically handle enums
  // well. We'll store the enum as its underlying integer type or a string. For
  // TemporalDistribution, int is fine.
};
